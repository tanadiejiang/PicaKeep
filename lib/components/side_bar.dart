...
/// Right-side panel route (matches PicaComic [SideBarRoute] behavior).
class SideBarRoute<T> extends PopupRoute<T> {
  ...
  Color? get barrierColor =>
      showBarrier ? Colors.black54 : Colors.transparent;
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    final wideLayout = MediaQuery.of(context).size.width > width;
...
void showSideBar(
  ...
  Navigator.of(context).push(SideBarRoute<void>(
    title,
    widget,
